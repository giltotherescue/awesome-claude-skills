...
- [Slashbooks](https://github.com/giltotherescue/slashbooks) - Bookkeeping skill: import bank and card activity, close the month, export files for your accountant.
